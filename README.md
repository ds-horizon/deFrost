...
```sh
yarn show-web -d <data-folder-location>
```
...
### Step 1: Prepare the APK with the Necessary Code (`yarn defrost-create-build`)
...
### Step 4: Visualize the Data (`yarn show-web`)
